...
class SuspensionModel:
    ...
    def generate_kin_plots(self, steer_sweep: np.ndarray, heave_sweep: np.ndarray, pitch_sweep: np.ndarray, roll_sweep: np.ndarray) -> None:
        ...
        ax_9[0, 0].set_ylabel("MR")
        ax_9[0, 0].set_title("FL MR")
        ...
        ax_9[0, 1].set_ylabel("MR")
        ax_9[0, 1].set_title("FR MR")
        ...
        ax_9[1, 0].set_ylabel("MR")
        ax_9[1, 0].set_title("RL MR")
        ...
        ax_9[1, 1].set_ylabel("RR MR")
        ax_9[1, 1].set_title("RR MR")
